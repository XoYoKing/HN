...
public class Constant {
     ...
     * FINISH("已完成");           4
     */
    public static final int SHOP_ORDER_STATUS_NEW = 0;
    public static final int SHOP_ORDER_STATUS_PREPARE = 1;
    public static final int SHOP_ORDER_STATUS_SEND = 2;
    public static final int SHOP_ORDER_STATUS_NOEVAL = 3;
    public static final int SHOP_ORDER_STATUS_FINISH = 4;
}
