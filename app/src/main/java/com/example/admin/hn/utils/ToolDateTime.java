...
public  class ToolDateTime {
	 ...
	 * @return
	 */
	public static String second2YMD(long dateL) {
	 ...
	 * @author hlc
	 * @param timeString
	 *            精确到毫秒的时间戳 格式为yyyy-MM-dd hh:mm:ss
	 * @return String类型的时间戳
	 */
	public static Date covertStringTimeToDate(String timeString) {
	 ...
	 * @return String类型的时间戳
	 */
	public static String covertLongTimeToString(long timeString) {
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat(
				"yyyy-MM-dd HH:mm:ss");
