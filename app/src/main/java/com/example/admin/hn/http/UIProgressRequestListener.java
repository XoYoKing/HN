...
import com.example.admin.hn.http.interf.ProgressRequestListener;
...
public abstract class UIProgressRequestListener implements ProgressRequestListener {
    ...
    private static class UIHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case REQUEST_UPDATE:
                    UIProgressRequestListener uiProgressRequestListener = mUIProgressRequestListenerWeakReference
                            .get();
                    if (uiProgressRequestListener != null) {
                        //获得进度实体类
                        ProgressModel progressModel = (ProgressModel) msg.obj;
                        //回调抽象方法
                        uiProgressRequestListener.onUIRequestProgress(
